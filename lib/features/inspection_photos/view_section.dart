import 'package:fahis_inspector/common/widgets/camera/image_viewer.dart';
...
class AlbumPhotos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = InspectionPhotosBinding().instance;
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Obx(() {
            List<Photo> photos =
                InspectionPhotosBinding().instance.photos.value;
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if(photos.length > index){
                              return ClipRRect(
                                ...
                                child: ImageViewer(image: photos[index].image),
                              );
                            }else{
                              return ClipRRect(
                                borderRadius: BorderRadius.circular(12),
