...
class _InspectionBodyNotesDialogState extends State<InspectionBodyNotesDialog> {
  ...
  List<Selection> _items = AppService.bodyNoteTypes;
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      actions: [
        TextButton(
          onPressed: () => !upload ? _submit() : print('is not allowed'),
          style: ButtonStyle(
  ...
  _pickImage() async {
    if (Platform.isAndroid || Platform.isIOS) {
      ...
      _marker.file = await Get.dialog<File>(
        CameraImagePicker(cameras: cameras),
      );
    } else {
