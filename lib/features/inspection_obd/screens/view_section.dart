...
import 'package:fahis_inspector/features/inspection_obd/screens/widgets/card.dart';
          ...
          children: [
            Card(
              ...
              child: GetBuilder<InspectionObdController>(
                init: InspectionObdController.instance,
                autoRemove: false,
                builder: (controller) {
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              backgroundColor: FColors.white,
                              child: IconButton(
                                onPressed: () => InspectionObdController.instance.onCreateEdit(),
                                icon: Icon(
                                  Iconsax.add,
                                  color: FColors.primaryColor,
                                ),
