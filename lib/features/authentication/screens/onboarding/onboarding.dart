import 'package:fahis_inspector/features/authentication/controllers/onboarding_controller.dart';
import 'package:fahis_inspector/features/authentication/screens/onboarding/widgets/onboarding_page.dart';
import 'package:fahis_inspector/features/authentication/screens/onboarding/widgets/onboarding_skip.dart';
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(shape: const CircleBorder(), backgroundColor: FColors.primaryColor),
        child: Icon(FLocalization.isArabic ? Iconsax.arrow_left_2 : Iconsax.arrow_right_3),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      ...
      child: SmoothPageIndicator(
        ...
        effect: const ExpandingDotsEffect(activeDotColor: FColors.primaryColor , dotHeight: 6),
      ),
    );
  }
}