...
class Arabic {
  ...
  static Map<String, String> ar = {
    ...
    InspectionPage.obdVinLabel: 'رقم الهيكل (اختياري)',
    InspectionPage.obdVinHint: 'Vehicle Identification Number',
    InspectionPage.obdDescLabel: 'الوصف',
    InspectionPage.obdDescHint: 'وصف الرمز...',
    InspectionPage.obdAiLookup: 'بحث AI',
    InspectionPage.obdAiLookingUp: 'جاري البحث...',
    InspectionPage.obdCausesLabel: 'الأسباب المحتملة',
    InspectionPage.obdSuggestionLabel: 'الإجراء المقترح',
